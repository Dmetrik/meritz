...
| | 읽는 사람 | 담는 것 |
|---|---|---|
| **1부 제품** (10개 섹션) | 기획·디자인·개발 모두 | 왜 만드나 · 누가 쓰나 · 어떻게 쓰나 · 화면 · 기능 · 안 하는 것 · 성공 지표 · 확인이 필요한 것 |
| **2부 개발 참고** (6개) | 개발자 | 데이터·API · 권한 · 연동 · 운영 · 기술 제약 |

1부에는 엔드포인트 경로나 함수 이름이 나오지 않습니다. 코드에서 발견한 기술적 사실은
사용자가 겪는 일로 번역해서 적고, 원문은 2부에 남깁니다.
...
- **`❓ 확인 필요`** — 코드로 알 수 없는 것은 지어내지 않고 질문으로 남기고,
  8번 섹션에 체크리스트로 모읍니다. 기획자가 문서를 열었을 때 보는 작업 목록입니다
